...
<style>
    ...
    form {
        width: 380px;
        padding: 40px;
        background-color: rgba(15, 15, 15, 0.9); /* Fond sombre transparent */
        border-radius: 20px;
    ...
    button {
        ...
        border: none;
        border-radius: 12px;
        background: linear-gradient(135deg, #560f0f, #560f0f); /* Dégradé vibrant */
        color: white;
        font-size: 18px;
        font-weight: 600;
        cursor: pointer;
...
<body>
    <!-- Formulaire pour ajouter un film, envoyant les données au fichier ajout_film.php -->
    <form method="post" action="ajout_film.php">
        ...
        <button type="submit" name="ajoutfilm">Ajouter film</button>
    </form>
</body>
</html>
